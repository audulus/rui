...
impl StateNode {
    pub fn new<T: 'static>(index: usize, state: T) -> Self {
        Self {
            index: index,
            state: Box::new(state),
            children: vec![],
...
mod tests {
    ...
    #[test]
    fn test_state_node_mut() {
        let mut stateNode0 = StateNode::new(0, String::from("parent"));
        let child = StateNode::new(0, String::from("child"));
        stateNode0.children.push(child);
    }
}
