                ...
                if input.state == ElementState::Pressed {
                    if let Some(code) = input.virtual_keycode {
                        let key = match code {
                            ...
                            VirtualKeyCode::A => Some(Key::Character("A")),
                            VirtualKeyCode::B => Some(Key::Character("B")),
                            VirtualKeyCode::C => Some(Key::Character("C")),
                            VirtualKeyCode::D => Some(Key::Character("D")),
                            VirtualKeyCode::E => Some(Key::Character("E")),
                            VirtualKeyCode::F => Some(Key::Character("F")),
                            VirtualKeyCode::G => Some(Key::Character("G")),
                            VirtualKeyCode::H => Some(Key::Character("H")),
                            VirtualKeyCode::I => Some(Key::Character("I")),
                            VirtualKeyCode::J => Some(Key::Character("J")),
                            VirtualKeyCode::K => Some(Key::Character("K")),
                            VirtualKeyCode::L => Some(Key::Character("L")),
                            VirtualKeyCode::M => Some(Key::Character("M")),
                            VirtualKeyCode::N => Some(Key::Character("N")),
                            VirtualKeyCode::O => Some(Key::Character("O")),
                            VirtualKeyCode::P => Some(Key::Character("P")),
                            VirtualKeyCode::Q => Some(Key::Character("Q")),
                            VirtualKeyCode::R => Some(Key::Character("R")),
                            VirtualKeyCode::S => Some(Key::Character("S")),
                            VirtualKeyCode::T => Some(Key::Character("T")),
                            VirtualKeyCode::U => Some(Key::Character("U")),
                            VirtualKeyCode::V => Some(Key::Character("V")),
                            VirtualKeyCode::W => Some(Key::Character("W")),
                            VirtualKeyCode::X => Some(Key::Character("X")),
                            VirtualKeyCode::Y => Some(Key::Character("Y")),
                            VirtualKeyCode::Z => Some(Key::Character("Z")),
